...
//        [_playButton setImage:[self getPictureWithName:@"CLPauseBtn"] forState:UIControlStateSelected];
        ...
        [_playButton setImage:[UIImage imageNamed:@"ic_video_pause"] forState:UIControlStateHighlighted];
        [_playButton setImage:[UIImage imageNamed:@"ic_video_0"] forState:UIControlStateSelected];
        _playButton.hidden = YES;
//        [_playButton setImage:[self getPictureWithName:@"ic_video_play"] forState:UIControlStateNormal];
//        [_playButton setImage:[self getPictureWithName:@"ic_video_pause"] forState:UIControlStateHighlighted];
//        [_playButton setImage:[self getPictureWithName:@"ic_video_0"] forState:UIControlStateSelected];
...
- (UIButton *) volumeButton{
    if (_volumeButton == nil){
        ...
        [_volumeButton setImage:[UIImage imageNamed:@"ic_play"] forState:UIControlStateNormal];
        [_volumeButton setImage:[UIImage imageNamed:@"ic_mute"] forState:UIControlStateSelected];
        
//        [_volumeButton setImage:[self getPictureWithName:@"ic_play"] forState:UIControlStateNormal];
//        [_volumeButton setImage:[self getPictureWithName:@"ic_mute"] forState:UIControlStateSelected];
...
- (void)volumeButtonAction:(UIButton *)button{
    button.selected = !button.selected;
    if (_delegate && [_delegate respondsToSelector:@selector(cl_volumButtonAction:)]) {
        [_delegate cl_volumButtonAction:button];
    }else{
        NSLog(@"没有实现代理或者没有设置代理人");
    }
}
